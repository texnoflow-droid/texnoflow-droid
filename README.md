...
<div align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=python,django,postgres,fastapi,js,ts,nodejs,express,mongodb,react,nextjs,html,css,linux,vscode,pycharm,git,github,docker,aws,kubernetes&theme=dark" width="100%" />
  </a>
</div>

<br/>

| ⚡ AI & Productivity Stack | 🏗 Infrastructure & Core Tech | 🌐 Frontend & Others |
| :--- | :--- | :--- |
| **Editors:** Cursor, Windsurf, Trae AI | **Language:** Python 3.12+ | **Language:** TS / JS |
| **Co-pilots:** Copilot, Qoder | **Framework:** Django (DRF) | **UI Tools:** React, HTML, CSS |
| **AI Focus:** LLMs, Automation | **Database:** PostgreSQL, Redis | **OS:** Arch Linux |
| **Workflow:** Zsh, Tmux | **Deployment:** Docker, Nginx | **VCS:** Git, GitHub |
